...
public class LambdaExercises {
	...
	/**
	 * Write a lambda expression that is a predicate that tests whether a string
	...
	/**
	 * Write an unbound method reference that is a predicate that tests whether
	 * a string is empty. An unbound method reference has a class name on the
	...
	/**
	 * Create a predicate that is true if the length of the provided string is 9
	 * or the provided string equals ERROR.
	 */
	@Test
	@Ignore
	...
	/**
	 * Given two Functions, one that converts a null reference to an empty
	 * string, and another that gets the length of a string, create a single
	 * function converts nulls and then gets the string's length.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write an unbound method reference that returns a new, empty
	 * StringBuilder.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write a lambda expression that returns the index of the first occurrence
	 * of the second string within the first string, or -1 if the second string
	 * doesn't occur within the first string.
	 */
	@Test
	@Ignore
	 ...
	 * occurrence of the second string within the first string, or -1 if the
	 * second string doesn't occur within the first string.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write a lambda expression that appends the 'suffix' variable (a String)
	...
	/**
	 * Write a lambda expression that takes a string argument and returns the
	 * index of that argument into the string "abcdefghij", or that returns -1
	 * if the string argument doesn't occur.
	 */
	@Test
	@Ignore
	...
	/**
	 * Write a bound method reference that takes a string argument and returns
	 * the index of that argument into the string "abcdefghij", or that returns
	 * -1 if the string argument doesn't occur. A bound method reference has an
	 * instance, or an expression that evaluates to an instance, on the
	 * left-hand side of the :: operator:
	 *
	 * myObject::methodname
	 *
	 * This is in contrast to an unbound method reference, which has a classname
